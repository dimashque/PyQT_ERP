...
################################################################################
## Form generated from reading UI file 'DebtList.ui'
##
...
class Ui_DebtList(object):
    def setupUi(self, DebtList):
        if not DebtList.objectName():
            DebtList.setObjectName(u"DebtList")
        DebtList.resize(800, 617)
        DebtList.setStyleSheet(u"background-color: #e4e4e4;\n"
"	color: #000;\n"
"	selection-background-color: #46a2da;\n"
"	selection-color: #fff;")
        self.centralwidget = QWidget(DebtList)
        ...
        self.listViewDebtList = QListView(self.frame)
        self.listViewDebtList.setObjectName(u"listViewDebtList")
        self.listViewDebtList.setGeometry(QRect(10, 10, 761, 321))
...
"}")
        ...
        self.frame_2.setGeometry(QRect(10, 390, 781, 181))
        ...
        self.gridLayout.addWidget(self.inputNum, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.inputComment, 1, 6, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.inputAgent, 1, 5, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.inputSum, 1, 4, 1, 1)
...
"")
        ...
        DebtList.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(DebtList)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 800, 22))
        DebtList.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(DebtList)
        self.statusbar.setObjectName(u"statusbar")
        DebtList.setStatusBar(self.statusbar)

        self.retranslateUi(DebtList)

        QMetaObject.connectSlotsByName(DebtList)
    # setupUi

    def retranslateUi(self, DebtList):
        DebtList.setWindowTitle(QCoreApplication.translate("DebtList", u"Debt List", None))
        self.label_2.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0645\u0628\u0644\u063a", None))
        self.label_5.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u062a\u0627\u0631\u064a\u062e", None))
        self.label_4.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0628\u064a\u0627\u0646", None))
        self.label_9.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0628\u064a\u0627\u0646", None))
        self.btnEdit.setText(QCoreApplication.translate("DebtList", u"\u062a\u0639\u062f\u064a\u0644", None))
        self.btnDelete.setText(QCoreApplication.translate("DebtList", u"\u062d\u0630\u0641", None))
        self.label_6.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0631\u0642\u0645", None))
        self.label_7.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0645\u0628\u0644\u063a", None))
        self.label_8.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0639\u0645\u064a\u0644", None))
        self.label_12.setText(QCoreApplication.translate("DebtList", u"\u0645\u062c\u0645\u0648\u0639 \u0627\u0644\u0630\u0645\u0645", None))
        self.label_11.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0645\u062a\u0628\u0642\u064a \u0639\u0644\u064a\u0647", None))
        self.label_10.setText(QCoreApplication.translate("DebtList", u"\u0627\u062e\u062a\u0631 \u0627\u0644\u0645\u0635\u062f\u0631", None))
        self.label_3.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0645\u0635\u062f\u0631", None))
        self.label.setText(QCoreApplication.translate("DebtList", u"\u0627\u0644\u0631\u0642\u0645", None))
    # retranslateUi
